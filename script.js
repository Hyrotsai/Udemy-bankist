...
console.log(Math.max(10, 23, 5, 8, 12));
console.log(Math.min(10, 23, 5, 8, 12));
console.log(Math.PI * Number.parseFloat('10px') ** 2);
console.log(Math.trunc(Math.random() * 6) + 1); //Numeros entre 1 y 6

// Random entre 2 valores
...
// Devuelve el valor mas arriba
console.log(Math.ceil(23.3));
console.log(Math.ceil(23.9));
// Devuelve el valor mas abajo
...
console.log(8 % 3); // = 2 por que 2*3 = 6 +2 = 8
...
labelBalance.addEventListener('click', function () {
  ...
  [...document.querySelectorAll('.movements__row')].forEach(function (row, i) {
    if (i % 2 === 0) row.style.backgroundColor = 'blue'; // 0,2,4,6,8
    if (i % 3 === 0) row.style.backgroundColor = 'yellow'; //0,3,6,9
  });
...
console.log(3511354321423432435453415181851554n);
